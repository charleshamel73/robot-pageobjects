...
class Logger(object):
    ...
    def get_threshold_level_as_str(self):
        """
        This method gets threshold level and normalizes it to upper
        :return: log level
        :rtype: str
        """
        ret = OptionHandler(self).get("log_level") or "INFO"
        return ret.upper()

    @staticmethod
    def get_log_level_from_str(level_as_str):
        """
        Convert string log level to integer logging level

        :param level_as_str: the log_Level
    ...
    @staticmethod
    def get_normalized_logging_levels(level_as_str):
        """
        ...
        :param level_as_str: log_level as string
        :type level_as_str: str
        :return: log level constant for robot/python
        :rtype: str
        """
